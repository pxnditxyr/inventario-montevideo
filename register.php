...
<div style="background-image: url( assets/images/auth-image-2.jpg )" class="flex items-center h-full w-full bg-cover bg-center overflow-y-auto">
      ...
      <div class="w-1/3 h-full overflow-y-auto">
        <form action="actions/register.php" method="post" class="flex flex-col items-center justify-center w-full h-full bg-white shadow-lg p-4 overflow-y-auto">
          <div class="flex flex-col items-center justify-center w-full p-4 bg-white shadow-lg">
          ...
          <div class="flex flex-col justify-start w-full bg-white shadow-lg gap-3">
          ...
          <div class="flex items-center justify-center w-full p-4 bg-white shadow-lg">
