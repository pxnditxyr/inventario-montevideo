...
<nav class="flex flex-row items-center justify-between bg-gray-800 text-white p-4">
  <ul class="flex flex-row items-center">
    <!-- class for @user -->
    <li class="flex flex-row items-center justify-center p-2 rounded-md hover:bg-gray-700 cursor-pointer"> ' . $_SESSION[ 'apellidos' ] . ' </li>
    <li class="flex flex-row items-center justify-center p-2 rounded-md hover:bg-gray-700 cursor-pointer"> ' . $_SESSION[ 'nombres' ] . ' </li>
    <li class="flex flex-row items-center justify-center p-2 rounded-md hover:bg-gray-700 cursor-pointer"> ' . $_SESSION[ 'email' ] . ' </li>
    <!-- class for links -->
