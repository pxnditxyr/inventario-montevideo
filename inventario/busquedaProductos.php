<?php
  ...
  function crearTabla ( $productos ) {
    ...
    foreach ( $productos as $producto ) {
      ...
      $tabla .= '<a href="editarProducto.php?id=' . $producto[ 'id' ] . '" class="class="text-indigo-600 hover:text-indigo-900"">Editar</a>';
        ...
        <div class="flex flex-col p-5 w-full">>
          ...
          <form action="busquedaProductos.php" method="POST" class="w-full flex flex-col gap-4">
            <div class="flex flex-row gap-4">
              <label for="search" class="text-gray-700 font-light text-xl">Buscar</label>
              <input type="text" name="search" id="search" value="' . $_POST[ 'search' ] . '" class="border border-gray-400 p-2 rounded">
            </div>
